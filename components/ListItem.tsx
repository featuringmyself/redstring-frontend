    ...
    <div className="rounded-2xl border-1 border-border-secondary bg-bg-secondary p-6 flex flex-col h-full">
      ...
      <div className={"grid grid-cols-2 gap-4 mt-auto"}>
        <button
          ...
          className={
            "flex items-center justify-center gap-1.5 text-sm bg-tertiary border-border-secondary border-[1px] px-4 py-2.5 rounded-lg font-bold shadow-sm shadow-[var(--ColorsEffectsShadowsshadow-xs)] hover:bg-[#FCFCFC] duration-300 hover:text-zinc-800 transition-colors cursor-pointer"
          }
        >
        ...
        <button
          ...
          className={
            "flex items-center justify-center gap-1.5 text-sm text-tertiary border-border-secondary border-[1px] px-4 py-2.5 rounded-lg font-bold bg-secondary shadow-[0px_1px_2px_0px_var(--ColorsEffectsShadowsshadow-xs)] hover:bg-blue-50 transition-colors cursor-pointer"
          }
        >
        ...
        <div className="fixed inset-0 backdrop-blur-sm flex flex-col items-center justify-center z-50 rounded-3xl px-8 pb-8 pt-10 gap-8">
          ...
          <div className="bg-black rounded-3xl border-[1px] border-[#424242] p-6 max-w-lg w-full mx-4 text-center flex gap-8 flex-col items-center justify-center">
            <Image
              ...
              className={"w-16 h-16"}
            />
            <h5 className={"text-[#F7F7F7] text-4xl tracking-tight leading-11"}>
            ...
            <div className={" text-[#424242] border-t-[0.5px] w-full pt-5"}>
              <p className={"text-blue-light font-normal"}>
